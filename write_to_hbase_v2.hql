create external table weather_delays_by_route_v2 (
  route string,
...
TBLPROPERTIES ('hbase.table.name' = 'weather_delays_by_route_v2');


insert overwrite table weather_delays_by_route_v2
