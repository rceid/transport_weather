...
object StreamDivvy {
  ...
  def main(args: Array[String]) {
    ...
    val batchStats = reports.map(dr => {
      ...
      put.addColumn(Bytes.toBytes("stat"), Bytes.toBytes("total_bus_trips"), Bytes.toBytes(dr.trips))
      put.addColumn(Bytes.toBytes("stat"), Bytes.toBytes("total_rail_trips"), Bytes.toBytes(dr.total_rail))
      put.addColumn(Bytes.toBytes("stat"), Bytes.toBytes("total_rides"), Bytes.toBytes(dr.total_bus + dr.total_rail))
      table.put(put)
